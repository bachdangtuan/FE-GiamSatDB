...
@Component({
    selector: 'app-bv-vietmy',
    templateUrl: './bv-vietmy.component.html',
    styleUrls: ['./bv-vietmy.component.scss']
})
export class BvVietmyComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.formSearchAndFilter.patchValue({
            hostName: 'vietmy-ttb-192-168-1-63',
            nameDatabase: '',
            page: 1,
            limit: 6,
        });
