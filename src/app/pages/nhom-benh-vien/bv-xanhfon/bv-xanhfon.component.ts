...
@Component({
    selector: 'app-bv-xanhfon',
    templateUrl: './bv-xanhfon.component.html',
    styleUrls: ['./bv-xanhfon.component.scss']
})
export class BvXanhfonComponent implements OnInit {
