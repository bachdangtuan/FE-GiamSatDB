...
@Component({
  selector: 'app-bv-dt',
  templateUrl: './bv-dt.component.html',
  styleUrls: ['./bv-dt.component.scss']
})
export class BvDtComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.pageTitle = [{label: 'Log Backup BV Đồng Tâm', path: '/', active: true}];
    this.formSearchAndFilter.patchValue({
      hostName: 'bvdt-db-slave-34',
      nameDatabase: '',
      page: 1,
      limit: 6,
    });
