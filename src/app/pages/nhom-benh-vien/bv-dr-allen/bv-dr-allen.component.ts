...
@Component({
  selector: 'app-bv-dr-allen',
  templateUrl: './bv-dr-allen.component.html',
  styleUrls: ['./bv-dr-allen.component.scss']
})
export class BvDrAllenComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.pageTitle = [{label: 'Log Backup Dr.Allen', path: '/', active: true}];
    this.formSearchAndFilter.patchValue({
      hostName: 'allen-db-slave-145',
      nameDatabase: '',
      page: 1,
      limit: 6,
    });
