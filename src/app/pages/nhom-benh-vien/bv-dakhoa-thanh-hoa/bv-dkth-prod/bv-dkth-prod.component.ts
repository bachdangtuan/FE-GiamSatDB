...
@Component({
    selector: 'app-bv-dkth-prod',
    templateUrl: './bv-dkth-prod.component.html',
    styleUrls: ['./bv-dkth-prod.component.scss']
})
export class BvDkthProdComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.pageTitle = [{label: 'Log Backup DKTH Prod', path: '/', active: true}];
        this.formSearchAndFilter.patchValue({
            hostName: 'dkth-db-slave-203',
            nameDatabase: '',
            page: 1,
            limit: 6,
        });
