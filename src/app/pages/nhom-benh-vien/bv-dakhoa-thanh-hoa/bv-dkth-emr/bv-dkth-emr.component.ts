...
@Component({
    selector: 'app-bv-dkth-emr',
    templateUrl: './bv-dkth-emr.component.html',
    styleUrls: ['./bv-dkth-emr.component.scss']
})
export class BvDkthEmrComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.pageTitle = [{label: 'Log Backup DKTH EMR', path: '/', active: true}];
        this.formSearchAndFilter.patchValue({
            hostName: 'dkth-db-emr-slave-205',
            nameDatabase: '',
            page: 1,
            limit: 6,
        });
